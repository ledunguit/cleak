# Memory Leak Report: scan_ownership_maze_mq8cvws8
...
- **Allocation type**: malloc
- Early return: `mode_banner` is freed on some paths but may not be released before every exit of session_open(). The allocation at /Users/zed/Master/leak-investigator/demo/memory_leak_corpus/ownership_maze/session.c:9 (`mode_banner`) has no matching free on the leaking path.
- **Suggested fix**: Review conditional branches around /Users/zed/Master/leak-investigator/demo/memory_leak_corpus/ownership_maze/session.c:9. At least one feasible path reaches function exit without hitting the observed free sites (free at line 12, free at line 13, free at line 28, free at line 29, free at line 30, free at line 31, free at line 32, free at line 39). Move cleanup into a shared epilogue or use a single-exit cleanup label.
...
- **Confidence**: 30% (Low)
- **Allocation type**: malloc
- Early return: an early return leaves the function before the allocated memory is freed The allocation at /Users/zed/Master/leak-investigator/demo/memory_leak_corpus/ownership_maze/session.c:83 has no matching free on the leaking path.
...
- **Confidence**: 45% (Medium)
- **Allocation type**: malloc
- Early return: `node` is freed on some paths but may not be released before every exit of queue_push(). The allocation at /Users/zed/Master/leak-investigator/demo/memory_leak_corpus/ownership_maze/queue.c:21 (`node`) has no matching free on the leaking path.
- **Suggested fix**: Review conditional branches around /Users/zed/Master/leak-investigator/demo/memory_leak_corpus/ownership_maze/queue.c:21. At least one feasible path reaches function exit without hitting the observed free sites (free at line 24, free at line 25, free at line 35). Move cleanup into a shared epilogue or use a single-exit cleanup label.
- **Root cause**: early_return
