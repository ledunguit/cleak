...
Clang Static Analyzer row scores 43 sites; the CLeak rows score 50. This is
...
path-sensitive --- living inside \texttt{interproceduralFlow}'s own
...
verdict stability or accuracy over the single-LLM baseline. A controlled
...
Future work has two concrete directions: evaluating the opt-in
...
often unavailable; and making \texttt{interproceduralFlow}'s cross-function
