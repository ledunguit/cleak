/**
 * Terminal design-system palette: colours + glyphs. The accent is a cyan/teal
 * (a "cyber console" cue rather than a warm/brand orange), with violet for
 * system/permission and a clear severity ramp (emerald → amber → rose) for
 * safe / likely / critical findings. Colours are hex so they render on truecolor
 * terminals via ink.
 */
