/**
 * Key-to-intent mapping and reducer for terminal-grade line editing. Extracted
 * from the parent `lineEdit` so PromptInput can import it locally without
 * cross-module coupling. Every function is pure and Ink-free.
 *
