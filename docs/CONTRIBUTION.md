...
Cùng 30 ca, cùng analyzer, 2 lần chạy mỗi nhánh:
...
→ **Bỏ phiếu k=3 cắt tỉ lệ lật verdict ~4×** và nâng case-stability 73% → 93%. (Trên cùng
hai lần chạy đó, P/R/F1 đại diện: single ~P0.71/R0.91/F1 0.80; consensus ~P0.75/R0.94/F1 0.83.)
